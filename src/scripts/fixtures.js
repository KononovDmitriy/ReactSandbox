...
// const commentsList = new schema.Array(comments);

// const articles = new schema.Entity('articles');
const articlesList = new schema.Array({
    comments: [comment]
});
// const articlesList = new schema.Array(article);


const normalizedData = normalize(originalArticles, articlesList);
